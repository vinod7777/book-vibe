...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=BBH+Bartle&family=BBH+Hegarty&family=Bungee&family=Roboto+Mono:ital,wght@0,100..700;1,100..700&family=Roboto+Slab:wght@100..900&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <section class="hero">
        <div class="purna">
            ...
            <h3 class="h3">Discover stories that inspire, ideas that transform,<br> and knowledge that empowers your
                journey.</h3>
            <h3 class="h3">Let your imagination rise beyond limits and<br> begin your next chapter today.</h3>
    ...
    <div class="sec33">
        ...
        <div><button class="sec40-btn">Schedule a Visit</button></div>
    </div>`;
    }

    const books = [{
            image: "https://m.media-amazon.com/images/I/91Pq2iyF1bL._AC_UF350,350_QL50_.jpg",
            type: "Fiction",
            price: "₹499",
            title: "Story Book",
        ...
        {
            image: "https://5.imimg.com/data5/SELLER/Default/2020/11/VX/JS/SY/49559104/story-books-500x500.jpg",
            type: "Non-Fiction",
            price: "₹399",
            title: "Learning Book",
        ...
        {
            image: "https://sureshiasacademy.store/wp-content/uploads/2025/04/TAMIL-SOCIETY-PART-1.jpg",
            type: "Academic",
            price: "₹699",
    ...
    <section>
        <div class="cardout">
            ...
            <div class="cardimgs cardin2">
                <div class="cardin21">
                    <img src="/assets/recommendedimgs/storybook-1.webp" alt="Recommended Book 1">
                    <button>View Details</button>
                </div>
                <div class="cardin21">
                    <img src="/assets/recommendedimgs/storybook-2.webp" alt="Recommended Book 2">
                    <button>View Details</button>
                </div>
                <div class="cardin21">
                    <img src="/assets/recommendedimgs/storybook-3.webp" alt="Recommended Book 3">
                    <button>View Details</button>
                </div>
                <div class="cardin21">
                    <img src="/assets/recommendedimgs/storybook-4.webp" alt="Recommended Book 4">
                    <button>View Details</button>
                </div>
            </div>
        </div>
    ...
    <footer class="f1">
        ...
        <h4 class="text1"> DESIGNED & DEVELOPED BY</h4>
